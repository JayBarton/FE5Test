...
void UnitResources::LoadUVs()
{
	...
	portraitUVs[15] = portraitTextures.GetUVs(528, 128, portraitX, portraitY, 3, 1);
	portraitUVs[16] = portraitTextures.GetUVs(0, 192, portraitX, portraitY, 3, 1);
	portraitUVs[17] = portraitTextures.GetUVs(144, 192, portraitX, portraitY, 3, 1);
	portraitUVs[18] = portraitTextures.GetUVs(288, 192, portraitX, portraitY, 3, 1);
	portraitUVs[19] = portraitTextures.GetUVs(432, 192, portraitX, portraitY, 3, 1);
	portraitUVs[20] = portraitTextures.GetUVs(576, 192, portraitX, portraitY, 3, 1);
}
